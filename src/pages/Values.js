...
export default function Values() {
  ...
  if(currentView === 'FAQ') {
    ...
    <div className={styles.values} >
      <p> The Panther Crush is built by students to enhance two simple aspects of traditional crush lists: privacy and respect. In terms of privacy, we don’t share your list with anyone, so no one sees your list and you don’t see anyone else's. This relieves the pressure of putting up a crush list in a public space while still allowing you to connect with you crush before graduation. </p>
      <p> At the same time, we’re committed to fostering a safe and respectful environment for you to make a new connection. Compared to traditional crush lists, the Panther Crush reduces the discomfort of having your name shown publicly on someone else’s list who you might not want to associate with. Instead, you and your crush need to consensually write each others name down for you to get a match, which is designed to improve transparency and respect between students. </p>
      <p>The Panther Crush is not intended to replace traditional crush lists; instead, it is intended to make crush lists more accessible to seniors by offering a more anonymous way to make a new connection before graduation.</p>
